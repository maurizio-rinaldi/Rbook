...
@  
\index{\texttt{setwd()}} 
 imposta la {\it working directory}  nella posizione specificata da \texttt{"indirizzo"}. Lavorando con RStudio per impostare la directory si pu\`o usare il menu a tendina
