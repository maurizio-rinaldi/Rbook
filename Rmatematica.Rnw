...
\Sexpr{fractions(Q[1]/P[1])}+\Sexpr{fractions(S[1]/R[1])}
\end{question}

\begin{solution}
Si determina il denominatore comune prendendo il minimo comune multiplo di \Sexpr{P[1]} e \Sexpr{R[1]}.
\end{solution}
\begin{question}
Si calcoli la frazione
\Sexpr{fractions(Q[2]/P[2])}+\Sexpr{fractions(S[2]/R[2])}
\end{question}
\\
\begin{question}
\Sexpr{fractions(Q[3]/P[3])}+\Sexpr{fractions(S[3]/R[3])}
\end{question}
